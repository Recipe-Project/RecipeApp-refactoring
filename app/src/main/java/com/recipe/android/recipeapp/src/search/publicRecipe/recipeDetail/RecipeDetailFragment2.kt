...
class RecipeDetailFragment2(private val processList: ArrayList<PublicRecipeProcess>) : BaseFragment<FragmentRecipeDetail2Binding>(
    FragmentRecipeDetail2Binding::bind,
    R.layout.fragment_recipe_detail2
) {
